...
for num in range(no_of_invaders):
    # invaderImage.append(pygame.image.load('xxx.png'))
...
# bulletImage = pygame.image.load('xxx.png')
bullet_X = 0
bullet_Y = 500
bullet_Xchange = 0
bullet_Ychange = 3
...
def invader(x, y, i):
    screen.blit(invaderImage[i-1], (x, y))
...
while running:
    ...
    for i in range(no_of_invaders):
        ...
        invader(invader_X[i-1], invader_Y[i-1], i)
